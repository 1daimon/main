<template>
	<div class="page">
		<div class="select" v-show="!readyselect">
			<image class="wait_ima" src="https://pic1.imgdb.cn/item/6349211716f2c2beb1d53835.png" mode="widthFix"></image>
		...
		<div class="user1">
			...
			<div class="user_name1">{{rival.name}}</div>
			<image class="person1"  :src="rival.ima" mode=""></image>
			</div>
	...
	export default{
		data(){
			return{
				rival:{
					name:'XXX',
					ima:'https://pic1.imgdb.cn/item/6338622e16f2c2beb125316b.png'
				},
				messages:[
					{
						per_name:"xhsa",
						per_i:"https://pic1.imgdb.cn/item/63491b2916f2c2beb1cbb862.jpg",
					},
					{
						per_name:"辽沈c",
						per_i:"https://pic1.imgdb.cn/item/63491b2916f2c2beb1cbb86d.jpg",
					},
					{
						per_name:"sac",
						per_i:"https://pic1.imgdb.cn/item/63491b2916f2c2beb1cbb87e.jpg",
					},
					{
						per_name:"asb",
						per_i:"https://pic1.imgdb.cn/item/63491b2916f2c2beb1cbb844.jpg",
					},
					{
						per_name:"记事本",
						per_i:"https://pic1.imgdb.cn/item/63491b2916f2c2beb1cbb875.jpg",
					}
				...
				isShow:true,
				times:[
					3000,5000,10000,4000,6000,30000,2000,7000
				]
			}
		},
		methods:{
			...
			step_in1(index){
				...
				if(this.full==1){
					...
					if(this.score1>this.score2){
						this.winner=this.rival.name
					}else{
						this.winner=this.name
					}
				
					this.message = `用户分数  ${this.rival.name}:${this.score1},${this.name}:${this.score2},胜者:${this.winner}`
			...
			dialogConfirm1() {
							...
							var that=this
							var item
							var wtime=this.times[Math.floor(Math.random()*this.times.length)]
							setTimeout(function(){
							
								that.decide_dif()
								 item=that.messages[Math.floor(Math.random()*that.messages.length)]
								that.rival.ima=item.per_i
								that.rival.name=item.per_name
							},wtime)
